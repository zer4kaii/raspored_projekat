...
public class Aktivnost {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "aktivnost_seq")
    @SequenceGenerator(name = "aktivnost_seq", sequenceName = "aktivnost_seq", allocationSize = 1)
